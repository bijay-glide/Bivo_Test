// Bu-web FX — Vietnam payee lifecycle. Three scenarios exercising saved-payee
...
test.describe('Bu-web FX — Vietnam payee lifecycle', () => {
  test.describe.configure({ retries: 1 });

  test('Reuses a Vietnam payee created via Bank Deposit for a second send via Mobile Wallet', async ({ page }) => {
  ...
  test('Edits a saved Vietnam payee from the standalone Payees list page, then sends to the edited payee', async ({ page }) => {
    test.setTimeout(180000);
  ...
  test('Edits a saved Vietnam payee from the transaction Review Transfer page, then confirms with the edit', async ({ page }) => {
    test.setTimeout(180000);
