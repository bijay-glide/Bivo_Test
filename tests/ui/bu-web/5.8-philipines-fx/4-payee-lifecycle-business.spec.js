// Bu-web FX — Philippines, business-payee lifecycle. Two scenarios exercising saved
...
test.describe('Bu-web FX — Philippines business-payee lifecycle', () => {
  test.describe.configure({ retries: 1 });

  test('Edits a saved Philippines business payee from the standalone Payees list page, then sends to the edited payee', async ({ page }) => {
  ...
  test('Edits a saved Philippines business payee from the transaction Review Transfer page, then confirms with the edit', async ({ page }) => {
    test.setTimeout(180000);
