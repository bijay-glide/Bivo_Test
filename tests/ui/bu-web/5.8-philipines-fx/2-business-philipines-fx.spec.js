// Bu-web FX — Philippines, business payee. Only one extra step versus the individual-
...
test.describe('Bu-web FX — Philippines, business payee', () => {
  test('Sends a new FX transaction to a Philippines business payee via Bank Deposit', async ({ page }) => {
  ...
  test('Sends a new FX transaction to a Philippines business payee via Instant Card Payout', async ({ page }) => {
    test.setTimeout(180000);
