// User-web FX — India payee lifecycle. Three scenarios exercising saved-payee reuse/edit
...
test.describe('User-web FX — India payee lifecycle', () => {
  test.describe.configure({ retries: 1 });

  test('Reuses an India payee created via IFSC for a second send via UPI', async ({ page, request }) => {
  ...
  test('Edits a saved India payee from the standalone Payees list page, then sends to the edited payee', async ({ page, request }) => {
    test.setTimeout(180000);
  ...
  test('Edits a saved India payee from the transaction Review Transfer page, then confirms with the edit', async ({ page, request }) => {
    test.setTimeout(180000);
