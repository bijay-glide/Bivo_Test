// User-web FX — Philippines (individual payee) lifecycle. Three scenarios exercising
...
test.describe('User-web FX — Philippines payee lifecycle', () => {
  test.describe.configure({ retries: 1 });

  test('Reuses a Philippines payee created via Bank Deposit for a second send via Mobile Wallet', async ({ page, request }) => {
  ...
  test('Edits a saved Philippines payee from the standalone Payees list page, then sends to the edited payee', async ({ page, request }) => {
    test.setTimeout(180000);
  ...
  test('Edits a saved Philippines payee from the transaction Review Transfer page, then confirms with the edit', async ({ page, request }) => {
    test.setTimeout(180000);
