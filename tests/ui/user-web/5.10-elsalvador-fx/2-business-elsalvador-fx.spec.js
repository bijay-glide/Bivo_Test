// User-web FX — El Salvador, business payee. Not recorded at all yet (unlike
...
test.describe('User-web FX — El Salvador, business payee', () => {
  test.fixme('Sends a new FX transaction to an El Salvador business payee', async ({ page, request }) => {
