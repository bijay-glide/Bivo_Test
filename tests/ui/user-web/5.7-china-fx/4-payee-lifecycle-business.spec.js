// User-web FX — China, business-payee lifecycle. Two scenarios exercising saved
...
// second non-card channel to reuse across.
...
test.describe('User-web FX — China business-payee lifecycle', () => {
  test.describe.configure({ retries: 1 });

  test('Edits a saved China business payee from the standalone Payees list page, then sends to the edited payee', async ({ page, request }) => {
  ...
  test('Edits a saved China business payee from the transaction Review Transfer page, then confirms with the edit', async ({ page, request }) => {
    test.setTimeout(180000);
